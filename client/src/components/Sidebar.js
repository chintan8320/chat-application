...
const Sidebar = () => {
    ...
    const handleCreateGrpModal = () => {
        setOpenSearchUser(true)
        setCreateGrpModal(true)
    }
    ...
    <div className='w-full h-full grid grid-cols-[48px,1fr] bg-white'>
            <div className='bg-slate-100 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-slate-600 flex flex-col justify-between'>
                <div>
                    ...
                    <div title='create group' onClick={()=>{handleCreateGrpModal()}} className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-200 rounded' >
            ...
            {
                openSearchUser && (
                    <SearchUser onClose={()=>handleCloseGrpModal()} createGrpModal={createGrpModal}/>
                )
            }
